...
public class JwtTokenProvider {
	...
	// Executa após o carregamento do Context do Spring 
	// e antes de qlq código da aplicação
	@PostConstruct
	protected void init() {
		// Busca dados do config para carregar na variável
	...
	private String getRefreshToken(String userName, List<String> roles, Date now) {
		...
		Date validityRefreshToken = new Date(now.getTime() + validInMilliseconds);
